    ...
    <div class="sidebar">
        ...
        <div class="sidebar-header text-center py-4">
            <a href="../index.php" class="d-flex align-items-center justify-content-center text-decoration-none">
                ...
                <span class="ms-2 fs-5 fw-bold text-white">AGENCE VOYAGE</span>
            </a>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="../utilisateur/index.php" class="nav-link">
                            <span class="icon"><i class="fas fa-users-cog"></i></span>
                            <span class="title">Utilisateurs</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../reservation/index.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="../destination/index.php" class="nav-link">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            ...
                            <span class="title">Aide & Support</span>
                        </a>
                    </li>
                </ul>
            </div>
