...
try {
    ...
    $stmt = $connect->query("SELECT SUM(montant) as total FROM paiements WHERE statut = 'payé'");
    $stats['chiffre_affaires'] = $stmt->fetch()['total'] ?? 0;
    
    // Dernières réservations
    $stmt = $connect->query("
        SELECT r.*, c.nom, c.prenom, d.nom as destination 
        FROM reservations r
    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-uppercase text-muted mb-2">Destinations</h6>
                                <h2 class="mb-0"><?= number_format($stats['destinations'] ?? 0, 0, ',', ' ') ?></h2>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="../destinations/" class="text-success text-decoration-none small">
                            Voir les destinations <i class="fas fa-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-uppercase text-muted mb-2">Réservations</h6>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="../reservations/" class="text-info text-decoration-none small">
                            Voir les réservations <i class="fas fa-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="mb-0"><?= number_format($stats['chiffre_affaires'] ?? 0, 2, ',', ' ') ?> €</h2>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="../paiements/" class="text-warning text-decoration-none small">
                            Voir les paiements <i class="fas fa-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white border-0">
                        <h5 class="mb-0">Voyages programmés</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h2 class="mb-0"><?= number_format($stats['voyages'] ?? 0, 0, ',', ' ') ?></h2>
                                <p class="text-muted mb-0">Voyages à venir</p>
                            </div>
                            <div class="icon-shape bg-orange bg-opacity-10 text-orange rounded-3 p-3">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h2 class="mb-0"><?= number_format($stats['paiements'] ?? 0, 0, ',', ' ') ?></h2>
                                <p class="text-muted mb-0">Paiements enregistrés</p>
                            </div>
                            <div class="icon-shape bg-teal bg-opacity-10 text-teal rounded-3 p-3">
